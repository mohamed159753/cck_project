...
export class UniversityManageReservationsService {

  private apiUrl = 'http://localhost:8080/api';

  constructor(private http: HttpClient) { }

  getReservations(universityId: any, startDate?: Date, endDate?: Date): Observable<any> {
    ...
    return this.http.get<any>(`${this.apiUrl}/reservations/university/${universityId}`, { params })
